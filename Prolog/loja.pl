...
lojaOp(1,[A,B,C,D,E,F,G,H,I,J,[_,_,PerArmas]],[QtdArmas , ListAr , QtdArmadura, ListaArmadura,QtdPocoes ,ListaPocoes],Novo) :-
...
lojaOp(2,[A,B,C,D,E,F,G,H,I,J,[_,PerArmaduras,_]],[QtdArmas , ListAr , QtdArmadura, ListaArmadura,QtdPocoes ,ListaPocoes],Novo) :- 
...
lojaOp(3,[A,B,C,D,E,F,G,H,I,J,[PerPocoes,_,_]],[QtdArmas , ListAr , QtdArmadura, ListaArmadura,QtdPocoes ,ListaPocoes],Novo) :- 
    print:printDinheiro(H), 
